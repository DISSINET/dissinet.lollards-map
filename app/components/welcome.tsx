    ...
    return (
      <div className="welcome" data-testid="welcome-wrapper">
        <div className="content ">
          ...
          <div className="footer w-100 bg-grey h-16 align-middle text-right p-4">
            <a target="_blank" href="https://dissinet.cz">
              <svg
